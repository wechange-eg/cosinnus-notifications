...
from cosinnus_notifications import get_version

setup(
    name='cosinnus-notifications',
    version=get_version(),
    description='cosinnus configurable notifications application',
